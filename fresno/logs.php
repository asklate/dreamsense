	...
	<section class="wrap-standard" id="column-3">
		<div class="wrap">
			...
			<div class="left-frame-top">
				<div class="panel-1"><a href="/">DEAMSENSE</a></div>
				<div class="panel-2">02<span class="hop">-262000</span></div>
			</div>
			<div class="right-frame-top">
				<div class="banner"> <a href="/">DREAMSENSE</a> &#149; <span class="blink">Online</span> </div>
				<div class="data-cascade-button-group">
					...
					<nav id="nav-standard"> 
						<a href="index.php" id="b-one">HOME</a>
						<a href="logs.php" id="b-two">LOGS</a>
			...
			<div class="right-frame">
				...
				<main>
					...
					<div class="lcars-text-bar the-end">
  						<span>Stardate 41154.9</span>
					</div>

					<p>We have taken heavy damage to our port nacelle. I've authorized a hold on
						emergency saucer seperation incase the warp core goes critical. The Romulans
						knew exactly where to hit us. I don't know how that's possible, but they did.
						I've sent an emergency distress call out to the Excalibur and the Roosevelt.
						Hell, I've even sent one to the Enterprise, but I know they're on the other side
						of the qaudrant doing their own studies and surveys. Better late than never
						I guess.
					</p>

					<div class="lcars-text-bar the-end">
  						<span>Stardate 41154.7</span>
					</div>

					<p>The Romulans have indeed penetrated Federation defenses. We managed to track
						down one of their ships crossing the border by accident. A class three probe
						was sent out to survey an anomoloy and that's when we saw a disturbance in
						subspace. We believe they use some kind of artificial singularity in their
						warp core, but cannot be certain.
					</p>

					<div class="lcars-text-bar the-end">
  						<span>Stardate 41153.2</span>
					</div>

					<p>The Fresno has been ordered to the Neutral Zone. Some suspicious activity has
						been happening along the Romulan border and we've been ordered to investigate.
                    </p>
                   
					<p>It's been years since anyone has seen a Romulan up close. I think the last time
						was when Kirk and his Enterprise ventured to the Neutral Zone to check out
						some destroyed starbases.
					</p>

					<p>Personally I hope for a confrontation. It would be nice to show the Romulans
						what we're made of. That the Federation just won't stand idly by and watch
						whatever it is they're up to.
					</p>
					
					<p>We'll be traveling at Warp Nine for the remainder of this mission. The Neutral
						Zone is pretty far away from Federation space as it is, our weapons are online
						in standby mode, I don't want to be caught with my pants down. The Roosevelt
						is in a nearby sector, if I have to we'll give her a call for backup. But I
						highly doubt the Romulans will want to make a move. They'll probably be cloaked
						and will not want to deal with us if we keep our nose clean.
					</p>
						...
						<div class="footer-inside">
							<div class="footer-text">
								...
								<p> <!-- Your copyright information is only a suggestion. You can also choose to delete this paragraph. -->
									Content Copyright &#169; <?php echo date("Y")?> DreamSense
								</p>
